...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pactools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15377&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pactools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pactools` can be installed with:

```
conda install pactools
```

It is possible to list all of the versions of `pactools` available on your platform with:
